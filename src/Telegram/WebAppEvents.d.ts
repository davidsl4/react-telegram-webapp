namespace Telegram.Unsafe.Events {
    ...
    type OnViewPortChangedHandler = (this: WebApp, props: {
    ...
    export type EventHandler<N extends EventsNames> = (this: WebApp, ...args: EventHandlerArguments<N>) => EventHandlerReturnType<N>;
}
