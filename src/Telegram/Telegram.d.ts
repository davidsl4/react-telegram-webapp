import { EventHandler } from './WebAppEvents';
...
export namespace Telegram.Unsafe {
    export type WebApp = {
         ...
         */
        onEvent(event: 'themeChanged', eventHandler: EventHandler<'themeChanged'>): void;
         ...
         */
        onEvent(event: 'viewportChanged', eventHandler: EventHandler<'viewPortChanged'>): void;
         ...
         */
        onEvent(event: 'mainButtonClicked', eventHandler: EventHandler<'mainButtonClicked'>): void;

        /** A method that deletes a previously set event handler. */
        offEvent(event: 'themeChanged' | 'viewportChanged' | 'mainButtonClicked', eventHandler: EventHandler<'themeChanged' | 'viewportChanged' | 'mainButtonClicked'>): void;
    ...
    export type MainButton = {
         ...
         */
        setParams(this: MainButton, params: {
            /** Current button text. */
            text?: string;
